...
BEGIN
	...
	BEGIN TRY
		...
		TRUNCATE TABLE bronze.crm_cust_info;  --Because The method we used to load the data is Truncate & Load; so we Truncate first then we load the data  
	
		PRINT('>>Inserting Data Into: bronze.crm_cust_info');
		BULK INSERT bronze.crm_cust_info      --BULK INSERT Inserts multiple data all at once instead Loading them row by row 
